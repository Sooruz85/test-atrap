...
import 'addprofiles_model.dart';
export 'addprofiles_model.dart';

class AddprofilesWidget extends StatefulWidget {
  const AddprofilesWidget({super.key});

  @override
  State<AddprofilesWidget> createState() => _AddprofilesWidgetState();
}

class _AddprofilesWidgetState extends State<AddprofilesWidget> {
  late AddprofilesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddprofilesModel());
                    ...
                    onPressed: () async {
                      await ProfilesRecord.collection.doc().set({
                        ...createProfilesRecordData(
                          username:
                              (_model.usernameFieldFocusNode?.hasFocus ?? false)
                                  .toString(),
                          bio: (_model.bioFieldFocusNode?.hasFocus ?? false)
                              .toString(),
